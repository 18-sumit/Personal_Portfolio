      ...
      >
        <div className="flex justify-between items-center px-0 py-3">
          ...
          >
            ...
            <div className="text-white text-2xl font-semibold">Sumit</div>
          </motion.div>
          ...
          <div className="hidden md:flex items-center space-x-12">
            ...
            <div className="flex items-center space-x-6 pl-10">
              <motion.a
                href="https://github.com/18-sumit"
                target="_blank"
              ...
              <motion.a
                href="https://linkedin.com/in/sumitdotdev/"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ y: -2 }}
                className="text-gray-400 hover:text-white transition-colors duration-200"
        ...
        >
          <div className="flex items-center justify-between h-16">
            ...
            >
              ...
              <div className="text-white text-xl font-semibold">Sumit</div>
            </motion.div>
